...
assert.doesNotMatch(engine, /record\.expectedAnswer|input\.expectedAnswer|\.answerText|proof\.text/);
assert.match(engine, /expectedAnswer/, "Le garde-fou doit reconnaître et signaler ce champ sensible.");
