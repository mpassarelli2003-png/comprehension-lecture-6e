...
function personalAppreciationPrompt(prompt) {
  return hasPhrase(prompt, /\b(aimes tu|as tu aime|qu as tu aime|qu est ce qui t a le plus interesse|que penses tu de|recommanderais tu|conseillerais tu|trouves tu|juges tu|quel passage as tu prefere|quelle partie as tu preferee|apprecies tu)\b/);
}
